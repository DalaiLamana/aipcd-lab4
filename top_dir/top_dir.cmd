...
"Configurator" import /home/alumnes/d/daniel.lamana/AIPCD/aipcd-lab4/axi_slave_64bits.sv
...
"Configurator" address_map create CTRL
"Configurator" address_map delete CTRL
"Configurator" address_map create MMAP
"Configurator" address_map delete MMAP
"Configurator" address_map create DCT
"Configurator" address_map DCT add MAP_NORMAL,"CTRL",0,MAP_NS,4'h0,64'h0,64'h0004,MEM_NORMAL,MAP_NORM_SEC_DATA
"Configurator" address_map DCT add MAP_NORMAL,"STATUS",0,MAP_NS,4'h0,64'h4,64'h0004,MEM_NORMAL,MAP_NORM_SEC_DATA
"Configurator" address_map DCT add MAP_NORMAL,"IN_BLOCK",0,MAP_NS,4'h0,64'h8,64'h0200,MEM_NORMAL,MAP_NORM_SEC_DATA
"Configurator" address_map DCT add MAP_NORMAL,"OUT_BLOCK",0,MAP_NS,4'h0,64'h208,64'h0200,MEM_NORMAL,MAP_NORM_SEC_DATA
...
"Configurator" sequence add axi4_master_0 axi4lite_rd_data_deparam_seq 0
"Configurator" sequence delete 0
"Configurator" sequence delete 0
"Configurator" sequence add axi4_master_0 axi4lite_rd_data_deparam_seq 0
"Configurator" sequence delete 1
"Configurator" sequence delete 0
"Configurator" sequence delete 0
"Configurator" sequence delete 0
"Configurator" sequence add axi4_master_0 axi4lite_wr_data_deparam_seq
...
"Configurator" sequence add axi4_master_0 axi4lite_rd_data_deparam_seq 1
"Configurator" sequence add axi4_master_0 axi4lite_rd_data_deparam_seq 2
"Configurator" sequence fork axi4_master_0 axi4lite_rd_data_deparam_seq 0
"Configurator" sequence delete 1
"Configurator" change variable vip_config.addr_map DCT
// "Configurator" generate
// jue. abr. 10 2025 14:42:21
